  ...
  return (
    <div className="min-h-screen bg-white flex flex-col relative overflow-hidden">
      ...
      <main className="flex-grow relative flex items-center justify-center px-4 pt-4 sm:pt-0 z-10">
        ...
        <div className="absolute bottom-24 left-4 sm:bottom-20 sm:left-10 z-20 text-left">
          <div className="flex flex-col gap-2 sm:gap-3">
            <span className="text-base sm:text-2xl text-gray-800 font-medium text-center" style={{width: 'fit-content', maxWidth: '100%'}}>Optimize the World</span>
      ...
      <video
        ...
        muted
        playsInline
        className="fixed inset-0 w-full h-full object-cover z-0 pointer-events-none opacity-15"
        style={{opacity:0.15}}
      >
