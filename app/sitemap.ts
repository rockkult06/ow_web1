...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Product pages (commented out until pages are created)
  // const products = [
  //   'ow-transitopt',
  //   'ow-fleetopt',
  //   'ow-ridersense',
  ...
  // Sector pages (commented out until pages are created)
  // const sectors = [
  ...
  // Success story pages (commented out until pages are created)
  // const stories = [
  //   'izmir-transport',
  ...
  // Contact pages (commented out until pages are created)
  // const contactPages = [
  //   {
  //     url: `${baseUrl}/contact`,
  //     lastModified: currentDate,
